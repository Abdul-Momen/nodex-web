...
const FtClientWhoServe = () => {
  return (
    <div className="w-full flex flex-col gap-10 justify-center items-center max-sm:mx-3 sm:mx-3">
      <h1 className="text-6xl font-abelPro font-bold text-designColor">
        Clients We{" "}
      ...
      <div className="w-full flex flex-row ms:flex-col max-sm:flex-col sm:gap-2 max-sm:gap-0 gap-10 justify-center items-center">
        <div className="w-[320px] h-[420px] flex flex-col justify-start p-3">
          ...
          <h1 className="text-2xl text-designColor font-abelPro font-bold mt-3 mb-2 ">
            Foodtech Startup
          </h1>
        ...
        {/* end 2nd */}
        <div className="w-[300px] h-[400px] flex flex-col justify-start p-2">
          <img
            src={WCD_MobDev}
            alt="Logo"
            width={120}
          ...
          <h1 className="text-2xl text-designColor font-abelPro font-bold mt-1 ">
            Restaurant
          </h1>
          <div className="flex flex-row justify-start  items-center">
            <p className="text-[16px] text-[#241468] font-abelPro  ">
