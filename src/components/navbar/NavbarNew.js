...
import { nodexLogo } from "../../assets/index.js";
          ...
          <ul className="flex flex-col items-center gap-5">
            ...
            <li>
              <NavLink
                ...
                <button className="bg-[#000000] text-white px-4 py-2 rounded-full hover:bg-[#D6343A] duration-500">
                  Get In Touch
                </button>
              </NavLink>
            </li>
      ...
      <div className="hidden lg:block">
        <ul className="flex items-center gap-10">
          ...
          <li>
            <NavLink
              to="/contact"
              className={`text-xl text-[#1C1F35] hover:text-black ${
                activePage === "contact" ? "active" : "none"
              }`}
              onClick={() => handleMenuClick("contact")}>
              <button className="bg-[#000000] text-white px-4 py-2 rounded-full hover:bg-[#D6343A] duration-500">
