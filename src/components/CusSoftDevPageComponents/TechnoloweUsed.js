    ...
    <section className="w-full  py-10 flex flex-row lg:flex-row xl:flex-row max-xl:flex-row md:flex-col sm:flex-col max-sm:flex-col   gap-5  justify-center items-center mt-10">
      <div className="w-full max-w-xl sm:w-full lg:w-full flex flex-col justify-center items-center gap-y-3 py-10 p-5">
        <button
          ...
          className={`${
            backEnd ? "bg-designColor" : "bg-[#241468]"
        ...
        <button
          ...
          className={`${
            frontEnd ? "bg-designColor" : "bg-[#241468]"
          } text-white py-3 px-5 rounded w-full flex justify-between items-center mx-4`}>
        ...
        <button
          ...
          className={`${
            desktop ? "bg-designColor" : "bg-[#241468]"
          } text-white py-3 px-5 rounded w-full flex justify-between items-center mx-4`}>
        ...
        <button
          ...
          className={`${
            mobile ? "bg-designColor" : "bg-[#241468]"
          } text-white py-3 px-5 rounded w-full flex justify-between items-center mx-4`}>
          Mobile Technologies
          <img
            src={workArrowImg}
        ...
        <button
          ...
          className={`${
            database ? "bg-designColor" : "bg-[#241468]"
          } text-white py-3 px-5 rounded w-full flex justify-between items-center mx-4`}>
        ...
        <button
          ...
          className={`${
            cloud ? "bg-designColor" : "bg-[#241468]"
          } text-white py-3 px-5 rounded w-full flex justify-between items-center mx-4`}>
          Cloud Technologies
          <img
            src={workArrowImg}
