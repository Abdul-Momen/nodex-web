    ...
    <div className="min-h-screen flex flex-col gap-5 items-center justify-center p-4">
      ...
      <div className="w-full md:w-auto mx-auto h-auto flex flex-col md:flex-row gap-5 justify-center p-4">
        ...
        <div className="w-full md:w-[350px] bg-white h-[250px] rounded-lg p-3 shadow-2xl">
          ...
          <p className="mt-4 max-sm:text-[14px] max-sm:p-3 font-abelPro ">
            Build innovative, client-focused software using agile methods, with
            a focus on quality and collaboration. Continuously improve through
            feedback and tech advancements
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-auto mx-auto h-auto flex flex-col md:flex-row gap-10 justify-center p-5">
        ...
        <div className="w-full md:w-[350px] bg-white h-[250px] rounded-lg p-3 shadow-2xl">
          ...
          <p className="mt-4 max-sm:text-[14px] max-sm:p-3 font-abelPro">
            Leverage deep industry expertise to deliver tailored software
            solutions, ensuring seamless user experiences. Continuously refine
        ...
        <div className="w-full md:w-[350px] bg-white h-[250px] rounded-lg p-3 shadow-2xl">
          ...
          <p className="mt-4 max-sm:text-[14px] max-sm:p-3 font-abelPro">
            Utilize the latest technologies to create efficient, scalable
            software solutions. Stay ahead through continuous innovation and
