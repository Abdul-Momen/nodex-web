    ...
    <div className="w-full h-[100vh] flex flex-col justify-end items-end bg-homePageBg mb-10">
      <div className="w-full relative">
        ...
        <div className="absolute top-0 left-0 w-full sm:w-1/2 h-full flex flex-col items-center sm:items-start justify-center sm:ml-20 text-[#FFFFFF]">
          <h1 className=" text-white text-4xl sm:text-5xl font-abelPro font-bold text-center sm:text-left">
            Elite Software Development Company{" "}
            <span className="mr-[3px] ml-[3px] "> </span>
          </h1>
          <h1 className=" mt-[4px] text-[#f80400] text-4xl sm:text-5xl font-abelPro font-bold text-center sm:text-left">
            To Build The Dreams For Next Generation.
          </h1>
          <p className=" mt-[4px] font-abelPro text-[#FFFFFF] leading-normal text-center sm:text-left">
