...
const WorkProcess = () => {
          ...
          <div className="w-full h-auto flex flex-col sm:w-full sm:1/2 mx-5 sm:mx-10 p-5">
            ...
            <div className=" w-full flex flex-row  gap-4 p-4 mx-2">
              <button
                ...
                className={`${
                  introCallInfo ? "text-designColor" : "text-[#193E65]"
  ...
  h-10 sm:h-8 md:h-10 lg:h-10 xl:h-12"
              ...
              <button
                ...
                className={`${
                  discoverPhInfo ? "text-designColor" : "text-[#193E65]"
                } flex flex-row gap-2 font-abelPro font-bold 
  text-20px sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl`}>
                DISCOVERY PHASE
              </button>
              ...
              <button
                ...
                className={`${
                  designPhInfo ? "text-designColor" : "text-[#193E65]"
                } flex flex-row gap-2 font-abelPro font-bold 
  text-20px sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl`}>
                DESIGN PHASE
              </button>
  ...
  h-10 sm:h-8 md:h-10 lg:h-10 xl:h-12"
              ...
              <button
                ...
                className={`${
                  developmentPhInfo ? "text-designColor" : "text-[#193E65]"
                } flex flex-row gap-2 font-abelPro font-bold 
  text-20px sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl`}>
                DEVELOPMENT PHASE
              </button>
  ...
  h-10 sm:h-8 md:h-10 lg:h-10 xl:h-12"
            ...
            <div className="flex flex-row gap-4 p-4 mx-2">
              <button
                ...
                className={`${
                  productLunchInfo ? "text-designColor" : "text-[#193E65]"
                } flex flex-row gap-2 font-abelPro font-bold 
  text-20px sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl`}>
                PRODUCT LAUNCH
              </button>
  ...
  h-10 sm:h-8 md:h-10 lg:h-10 xl:h-12"
              ...
              <button
                ...
                className={`${
                  supportInfo ? "text-designColor" : "text-[#193E65]"
                } flex flex-row gap-2 font-abelPro font-bold 
  text-20px sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl`}>
                SUPPORT
              </button>
