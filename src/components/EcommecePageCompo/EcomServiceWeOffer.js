...
const EcomServiceWeOffer = () => {
  return (
    <div className="flex flex-col justify-center items-center  bg-white mb-20">
      <h1 className=" max-xl:text-6xl xl:text-6xl  lg:text-6xl md:text-5xl sm:text-4xl max-sm:text-4xl text-center text-designColor font-abelPro font-bold leading-normal mb-10 mt-5">
