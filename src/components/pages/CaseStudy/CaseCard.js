          ...
          <div
            ...
            <div className="flex flex-row gap-1 justify-start items-start  text-left mx-1 ">
              <a href="/mobileppdevpage">
                <p className="text-designColor font-abelPro 2xl:text-[16px] lg:text-[14px] md:text-[14px] sm:text-[12px] max-sm:text-[12px] p-2  underline underline-offset-1">
                  Mobile development
                </p>
              </a>
              {/* end */}
              <a href="/iot">
                <p className="text-designColor font-abelPro xl:text-[16px] 2xl:text-[16px] lg:text-[14px] md:text-[14px] sm:text-[12px] max-sm:text-[12px] p-2  underline underline-offset-1">
                  IoT Solutions
                </p>
              </a>
              {/* end */}
            ...
            <div className=" flex flex-col justify-center items-center p-2 ">
              ...
              <a
                ...
                <h2 className=" text-lg text-designColor font-bold">
                  Learn more
                </h2>
                <img
                  src={learnArrowImg}
