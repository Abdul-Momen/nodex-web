      ...
      <div className="w-full">
        <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
          ...
          <div className="w-full lg:w-[50%] h-full flex flex-col justify-between bg-[#f4f4f4] p-4 lg:p-2 gap-4">
            <form
              id="form"
              action="https://getform.io/f/bpjmergb"
              method="POST"
              className="w-full flex flex-col gap-4 py-2">
              {errMessage && (
                <p className="py-3 bg-white shadow-shadowOne text-center text-[#f80400] text-base tracking-wide animate-bounce">
                  {errMessage}
                </p>
              )}
              ...
              <div className="flex flex-col lg:flex-row gap-4">
                <div className="w-full lg:w-1/2 flex flex-col gap-2">
                  <p className="text-base lg:text-lg font-abelPro font-bold text-[#f80400] uppercase tracking-wide">
                    Name
                  </p>
                  <input
              ...
              <div className="w-full">
                <button
                  onClick={handleSend}
                  className="sendMessageButton bg-[#f80400] text-white py-2 px-4 rounded-lg hover:bg-red-600 focus:outline-none focus:ring focus:border-blue-300">
                  Send Message
                </button>
              </div>
            </form>
